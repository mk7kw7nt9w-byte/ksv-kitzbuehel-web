...
export default function GalerieContent({
  nadpis = "Galéria",
  popis = "Tréning, vybavenie a pohľad do budovania K.S.V. Kitzbühel.",
}: {
  nadpis?: string;
  popis?: string;
}) {
  const items = [
    ...
    { label: "Vybavenie" },
    { label: "Komunita" },
    { label: "Klubový priestor", wide: true },
  ];
      ...
      <section className="mx-auto max-w-6xl px-4">
        <div className="mb-8 rounded-lg border border-zinc-800 bg-zinc-900/60 p-6 text-center">
          ...
          <p className="mx-auto max-w-xl text-sm leading-relaxed text-zinc-500">
            K.S.V. Kitzbühel práve budujeme. Prvé fotografie z tréningov,
            vybavenia a klubových aktivít doplníme čoskoro.
          </p>
        </div>
